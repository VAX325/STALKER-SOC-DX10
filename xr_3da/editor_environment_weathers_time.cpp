...
void time::thunderbolt_setter(LPCSTR value)
{
	...
	tb_id = m_manager.eff_Thunderbolt->AppendDef(m_manager, m_manager.m_thunderbolt_collections_config,
...
void time::fill(editor::property_holder_collection* collection)
{
	...
	m_property_holder->add_property("far plane", "fog", "this option is resposible for far plane", far_plane,
									far_plane);
	m_property_holder->add_property("distance", "fog",
									"this option is resposible for fog distance (shoudl be less than far plane)",
									fog_distance, fog_distance);
	m_property_holder->add_property("density", "fog", "this option is resposible for fog density (0..1)", fog_density,
									fog_density, 0.f, 1.f);
	...
	m_property_holder->add_property("duration", "thunderbolts", "this option is resposible for thunderbolt duration",
									bolt_duration, bolt_duration);
	m_property_holder->add_property("period", "thunderbolts", "this option is resposible for thunderbolt period",
	...
	m_property_holder->add_property("velocity", "wind",
									"this option is resposible for wind velocity (meters per second)", wind_velocity,
