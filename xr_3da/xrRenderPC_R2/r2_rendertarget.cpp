...
CRenderTarget::CRenderTarget()
{
	...
	//	NORMAL
	{
		...
		if (RImplementation.o.advancedpp) rt_Generic_2.create(r2_RT_generic2, w, h, D3DFMT_A16B16G16R16F);
	}
	...
	if (RImplementation.o.HW_smap)
	{
		...
		if (RImplementation.o.advancedpp) s_accum_direct_volumetric.create("accum_volumetric_sun");
	}
	else
	{
		u32 size = RImplementation.o.smapsize;
	...
	HW.pDevice->CreateOffscreenPlainSurface(Device.dwWidth, Device.dwHeight, desc.Format, D3DPOOL_SYSTEMMEM, &pFB,
											NULL);
...
void CRenderTarget::increment_light_marker()
{
	...
	if (dwLightMarkerID > 255) reset_light_marker(true);
}
