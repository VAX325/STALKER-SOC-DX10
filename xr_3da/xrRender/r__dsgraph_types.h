...
public:
	...
	void construct(pointer p, const T& _Val) { std::_Construct_in_place(*p, _Val); }
...
namespace R_dsgraph
{
	...
	struct mapNormalStates : public FixedMAP<state_type, mapNormalTextures, render_allocator>
	{
		float ssa;
	};
	...
	struct mapMatrixStates : public FixedMAP<state_type, mapMatrixTextures, render_allocator>
	{
		float ssa;
	};
