...
void flare::fill(editor::property_holder_collection* collection)
{
	...
	properties->add_property("opacity", "flare", "this option is resposible for gradient opacity", m_opacity,
							 m_opacity);
	properties->add_property("position", "flare", "this option is resposible for gradient position", m_position,
							 m_position);
