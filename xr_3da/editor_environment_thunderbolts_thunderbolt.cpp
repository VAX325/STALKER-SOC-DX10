...
void thunderbolt::fill(::editor::environment::manager& environment, ::editor::property_holder_collection* collection)
{
	...
	m_property_holder->add_property("id", "properties", "this option is resposible for thunderbolt id", m_id.c_str(),
	...
	m_center->fill(environment, "center", "this option is resposible for thunderbolt gradient center",
				   *m_property_holder);
