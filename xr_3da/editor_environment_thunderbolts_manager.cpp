...
template <>
void property_collection<manager::thunderbolt_container_type, manager>::display_name(u32 const& item_index,
																					 LPSTR const& buffer,
...
template <>
void property_collection<manager::collection_container_type, manager>::display_name(u32 const& item_index,
																					LPSTR const& buffer,
																					u32 const& buffer_size)
{
	strcpy_s(buffer, buffer_size, m_container[item_index]->id());
...
void manager::fill(editor::property_holder* holder)
{
	...
	holder->add_property("thunderbolts", "thunderbolts", "this option is resposible for thunderbolts",
