...
template <>
void property_collection<collection::container_type, collection>::display_name(u32 const& item_index,
																			   LPSTR const& buffer,
...
void collection::fill(editor::property_holder_collection* collection)
{
	...
	m_property_holder->add_property("thunderbolts", "properties", "this option is resposible for thunderbolts",
									m_collection);
}
