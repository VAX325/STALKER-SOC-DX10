...
CBlender_default::CBlender_default() { description.CLS = B_DEFAULT; }

CBlender_default::~CBlender_default() {}
void CBlender_default::Save(IWriter& fs) { IBlender::Save(fs); }
void CBlender_default::Load(IReader& fs, u16 version) { IBlender::Load(fs, version); }
