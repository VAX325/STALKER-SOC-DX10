...
struct CCloner
{
	...
	template <typename T>
	struct CHelper<T, false>
	{
		IC static void clone(const T& _1, T& _2) { _2 = _1; }
	};
	...
	{
		IC static void clone(const T& _1, T& _2) { CHelper3::clone(_1, _2); }
	};
