...
{
protected:
	typedef CPathManager<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type,
						 _index_type, _iteration_type>
		this_type;
...
public:
	...
	IC const _index_type& get_value(_Graph::const_iterator& i, bool reverse_search = _Graph::reverse_search) const;
	IC const _edge_type& edge(_Graph::const_iterator& i) const;
