					...
					::editor::property_holder& holder)
{
	...
	m_property_holder->add_property("opacity", "properties",
									"this option is resposible for thunderbolt gradient opacity", fOpacity, fOpacity);
	m_property_holder->add_property("minimum radius", "properties",
									"this option is resposible for thunderbolt gradient minimum radius", fRadius.x,
									fRadius.x);
	m_property_holder->add_property("maximum _radius", "properties",
									"this option is resposible for thunderbolt gradient maximum radius", fRadius.y,
									fRadius.y);
