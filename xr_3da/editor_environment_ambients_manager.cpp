...
template <>
void property_collection<manager::ambient_container_type, manager>::display_name(u32 const& item_index,
																				 LPSTR const& buffer,
...
void manager::load()
{
	...
	for (; i != e; ++i)
	{
		...
		object->load(*m_manager.m_ambients_config, *m_manager.m_sound_channels_config, *m_manager.m_effects_config,
					 (*i)->Name);
