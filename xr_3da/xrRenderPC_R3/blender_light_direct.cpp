...
void CBlender_accum_direct::Compile(CBlender_Compile& C)
{
	...
	switch (C.iElement)
	{
		case SE_SUN_NEAR: // near pass - enable Z-test to perform depth-clipping
			//	FVF::TL2uv
			C.r_Pass("stub_notransform_2uv", "accum_sun_near_nomsaa_nominmax", false, TRUE, FALSE, blend, D3DBLEND_ONE,
					 dest);
		...
		case SE_SUN_NEAR_MINMAX: // near pass - enable Z-test to perform depth-clipping
			//	FVF::TL2uv
			C.r_Pass("stub_notransform_2uv", "accum_sun_near_nomsaa_minmax", false, TRUE, FALSE, blend, D3DBLEND_ONE,
					 dest);
			C.r_CullMode(D3DCULL_NONE);
			C.PassSET_ZB(TRUE, FALSE, TRUE); // force inverted Z-Buffer
...
void CBlender_accum_direct_msaa::Compile(CBlender_Compile& C)
{
	...
	switch (C.iElement)
	{
		case SE_SUN_NEAR: // near pass - enable Z-test to perform depth-clipping
			...
			C.r_Pass("stub_notransform_2uv", "accum_sun_near_msaa_nominmax", false, TRUE, FALSE, blend, D3DBLEND_ONE,
					 dest);
			C.r_CullMode(D3DCULL_NONE);
			C.PassSET_ZB(TRUE, FALSE, TRUE); // force inverted Z-Buffer
			// C.r_Sampler_rtf		("s_position",		r2_RT_P			);
		...
		case SE_SUN_NEAR_MINMAX: // near pass - enable Z-test to perform depth-clipping
			//	FVF::TL2uv
			C.r_Pass("stub_notransform_2uv", "accum_sun_near_msaa_minmax", false, TRUE, FALSE, blend, D3DBLEND_ONE,
					 dest);
			C.r_CullMode(D3DCULL_NONE);
			C.PassSET_ZB(TRUE, FALSE, TRUE); // force inverted Z-Buffer
...
void CBlender_accum_direct_volumetric_msaa::Compile(CBlender_Compile& C)
{
	...
	switch (C.iElement)
	{
		case 0: // near pass - enable Z-test to perform depth-clipping
			C.r_Pass("stub_notransform_2uv", "accum_volumetric_sun_msaa", false, TRUE, FALSE, blend, D3DBLEND_ONE,
					 dest);
...
void CBlender_accum_direct_volumetric_sun_msaa::Compile(CBlender_Compile& C)
{
	...
	{
		case 0: // near pass - enable Z-test to perform depth-clipping
			C.r_Pass("stub_notransform_2uv", "accum_volumetric_sun_msaa", false, false, false, true, D3DBLEND_ONE,
