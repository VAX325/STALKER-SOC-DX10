...
private:
	...
	//	OA option handling
	void DescribeOption(const char* pszOptionName, const oaOptionDependency& Dependency);
	oaOptionDataType GetOptionType(const char* pszOptionName);
	void GetOption(const char* pszOptionName);
