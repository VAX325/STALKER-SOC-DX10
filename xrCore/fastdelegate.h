...
// need to be treated as a special case.
		...
		struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + sizeof(int)>
		{
			...
			inline static GenericClass* Convert(X* pthis, XFuncType function_to_bind, GenericMemFuncType& bound_func)
			{
				...
				static_assert(sizeof(function_to_bind) == sizeof(u.s), "ERROR: Cant Use horrible_cast");
...
#pragma warning(pop)
	...
	public:
		...
		// Binding to const member functions.
		template <class X, class Y>
		FastDelegate4(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
																					   Param4 p4) const)
		{
			m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
		}
		template <class X, class Y>
		inline void bind(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2,
	...
	public:
		...
		// Binding to non-const member functions
		template <class X, class Y>
		FastDelegate5(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
																				 Param4 p4, Param5 p5))
		{
			m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
		}
	...
	public:
		...
		// Binding to non-const member functions
		template <class X, class Y>
		FastDelegate6(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
	...
	public:
		...
		// Binding to const member functions.
		template <class X, class Y>
		FastDelegate8(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
																					   Param4 p4, Param5 p5, Param6 p6,
...
#define FASTDLGT_RETTYPE RetType
	...
	template <class X, class Y, class Param1, class Param2, class RetType>
	FastDelegate2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (xr_stdcall X::*func)(Param1 p1,
																									 Param2 p2) const)
	{
		return FastDelegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
	}
	...
	FastDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x, RetType (xr_stdcall X::*func)(Param1 p1,
																											 Param2 p2,
																											 Param3 p3))
	{
