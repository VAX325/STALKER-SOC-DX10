...
public:
	// construction
	resptr_core() { this_type::p_ = 0; }
	resptr_core(T* p, bool add_ref = true)
	{
		this_type::p_ = p;
		if (add_ref) this_type::_inc();
	}
	...
	// accessors
	T& operator*() const { return *this_type::p_; }
	T* operator->() const { return this_type::p_; }

	// unspecified bool type
	typedef T* (this_type::*unspecified_bool_type)() const;
	operator unspecified_bool_type() const { return this_type::p_ == 0 ? 0 : &resptr_core::_get; }
	bool operator!() const { return this_type::p_ == 0; }
