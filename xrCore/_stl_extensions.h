...
protected:
	...
	typedef const T& size_type;
	typedef typename allocator::size_type size_type_t;
...
public:
	...
	const_reference_t operator[](size_type_t _Pos) const
	{
		{
			VERIFY(_Pos < size());
		}
	...
	reference_t operator[](size_type_t _Pos)
	{
		{
			VERIFY(_Pos < size());
		}
